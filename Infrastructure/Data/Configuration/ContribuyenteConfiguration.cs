...
namespace Infrastructure.Data.Configuration
{
    internal class ContribuyenteConfiguration : IEntityTypeConfiguration<Contribuyente>
    {
        public void Configure(EntityTypeBuilder<Contribuyente> builder)
        {
            ...
            builder.HasMany(contribuyente => contribuyente.ComprobantesFiscales)
                   .WithOne(comprobante => comprobante.Contribuyente)
                   .HasForeignKey(comprobante => comprobante.ContribuyenteId);
        }
    }
}
